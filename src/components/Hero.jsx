...
const Hero = () => {
  ...
  return (
    <div
      className="relative isolate px-6 lg:px-8 bg-cover bg-center bg-no-repeat h-[80vh] z-10"
      ...
      <div className="relative mx-auto max-w-3xl flex flex-col items-center justify-center h-full z-20">
        <div>
          ...
          <p className="mt-4 text-[12px] text-background">
            At PRO INSPECT AUTO, we ensure your vehicle is safe and roadworthy.
            Our certified inspectors use the latest technology for thorough
            inspections.
          </p>
