                    ...
                    <ul className="flex flex-wrap -mb-px">
                        <li className="me-2">
                            <button
                                ...
                                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'CARFAX' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
                            >
                                CARFAX
                            </button>
                        </li>
                        <li className="me-2">
                            <button
                                ...
                                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'Auto Check' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
                            >
                                Auto Check
                            </button>
                        </li>
                        <li className="me-2">
                            <button
                                ...
                                className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'UK' ? 'text-blue-600 border-blue-600' : 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
                            >
                                UK
                            </button>
                        </li>
                    ...
                    <div className="bg-white shadow-lg rounded-lg p-6 mt-6">
                        <div className='w-full'>
                            ...
                            <div className="p-4 border rounded-b-lg">
                                <h3 className="text-lg font-semibold">2012 JEEP COMPASS</h3>
                                <p className="text-gray-600">VIN: 1C4NJAB8CD575556</p>
                                <p className="text-gray-600">4 DOOR WAGON/SPORT UTILITY • 2.4L I4 DOHC 16V • GASOLINE</p>
                                <p className="text-gray-600">FRONT WHEEL DRIVE W/ 4X4</p>

                                <div className="mt-4 space-y-3">
                                    <div className="flex items-center space-x-2 text-green-600">
                                        <FaCheckCircle />
                                        <span>No accidents or damage reported to CARFAX</span>
                                    </div>
                                    <div className="flex items-center space-x-2 text-gray-700">
                                        <FaCar />
                                        <span>3 Service history records</span>
                                    </div>
                                    <div className="flex items-center space-x-2 text-red-600">
                                        <FaTimesCircle />
                                        <span>4 Previous owners</span>
                                    </div>
                                    <div className="flex items-center space-x-2 text-gray-700">
                                        <FaRoad />
                                        <span>Types of owners: Commercial, Personal</span>
                                    </div>
                                    <div className="flex items-center space-x-2 text-gray-700">
                                        <FaRoad />
                                        <span>Last owned in Quebec</span>
                                    </div>
                                    <div className="flex items-center space-x-2 text-gray-700">
                                        <FaRoad />
                                        <span>106,875 Last reported odometer reading</span>
                                    </div>
                                </div>
                            </div>
                        </div>
